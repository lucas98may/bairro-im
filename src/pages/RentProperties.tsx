    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="bg-realestate-primary text-white py-12">
        <div className="container mx-auto px-4">
          ...
          <p className="text-lg mb-8">Encontre o imóvel ideal para alugar no Bairro Alegre</p>
      ...
      <section className="py-12">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-2xl font-bold">Imóveis para Aluguel</h2>
          ...
          {filteredProperties.length > 0 ? (
            ...
            <div className="text-center py-12">
              <h3 className="text-xl font-medium text-gray-500">Nenhum imóvel para alugar encontrado para os critérios selecionados</h3>
